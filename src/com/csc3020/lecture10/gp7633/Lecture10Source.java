...
public class Lecture10Source {
    public static void main(String[] args) {
        ...
        FullLicensedPilot oFullLicensedPilot = new FullLicensedPilot();
        canAccept = oFullLicensedPilot.canAccept(oCargoFlight);
        if (canAccept) {
            System.out.println("The FullyLicensedPilot can accept the flight");
        }
        else {
            System.out.println("The FullyLicensedPilot can't accept the flight");
        }
