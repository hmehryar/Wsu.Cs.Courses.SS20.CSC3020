...
public class Lecture10Source {
    public static void main(String[] args) {
        ...
        if (canAccept) {
            System.out.println("The pilot can accept");
        }
        ...
        FullLicensedPilot oFullLicensePilot = new FullLicensedPilot();
        canAccept = oFullLicensePilot.canAccept(oCargoFlight);
        if (canAccept) {
            System.out.println("The FullLicensedPilot can accept the flight");
        }
        else {
            System.out.println("The FullLicensedPilot can't accept the flight");
        }
