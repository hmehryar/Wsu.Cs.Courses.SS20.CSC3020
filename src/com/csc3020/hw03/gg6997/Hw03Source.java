...
public class Hw03Source {
    public static void main(String[] args) {
        ...
        csc3020.hw03.gg6997.MathEquation calculations[]=new csc3020.hw03.gg6997.MathEquation[4];
        //new variable given values and assigns them to MathEquation class
        calculations[0] = new csc3020.hw03.gg6997.MathEquation(100,50,'/');
        calculations[1] = new csc3020.hw03.gg6997.MathEquation(25,92,'+');
        calculations[2] = new csc3020.hw03.gg6997.MathEquation(225,17,'-');
        calculations[3] = new csc3020.hw03.gg6997.MathEquation(11,3,'*');
