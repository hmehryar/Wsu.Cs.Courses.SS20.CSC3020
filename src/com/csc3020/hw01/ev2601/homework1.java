...
package csc3020.hw01.ev2601; // package info
...
public class homework1 {
    ...
    public static void main(String[] args) {
        ...
        for (char op : opCodes) { // enter loop to iterate over opCodes
            ...
            for (int i = 0; i < 4; i++) { // iterate over lVals and rVals
                calculate(op, lOperands[i], rOperands[i]);   // perform operation and print solution
            }
    ...
    /* function to perform operation on 'val1' and 'val2' determined by opCode value */
    private static void calculate(char opCode, double val1, double val2) {
        ...
        switch (opCode) {
            case 'a':
                System.out.print(ft.format(val1 + val2) + "\t");
                break;
            case 's':
                System.out.print(ft.format(val1 - val2) + "\t");
                break;
