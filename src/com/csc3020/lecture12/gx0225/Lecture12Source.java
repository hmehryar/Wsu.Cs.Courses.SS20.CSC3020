...
public class Lecture12Source {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Passenger oPassenger1=new Passenger(3);
        ...
        try{
            ...
            System.out.println("Error: Invalid value: "+oNumberFormatException);

        }
        catch (FileNotFoundException oFileNotFoundException){
            System.out.println("Error: Invalid path: "+oFileNotFoundException);

        }
        catch (IIOException oIoException){
            System.out.println("Error: Invalid: "+oIoException);
