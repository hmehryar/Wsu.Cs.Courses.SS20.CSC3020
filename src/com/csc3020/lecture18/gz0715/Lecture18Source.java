...
public class Lecture18Source {
    ...
    public static void doTryCatchFinally() {
        ...
        try {
            reader = Helper.openReader("E:\\CSC3020SS20\\src\\com\\csc3020\\lecture18\\gz0715\\file1.txt");
    ...
    public static void doTryCatchSources() {
        ...
        try (Reader reader = Helper.openReader("E:\\CSC3020SS20\\src\\com\\csc3020\\lecture18\\gz0715\\file1.txt")) {
    ...
    public static void doTryWithMultiResources() {
        ...
        int length;
        try (Reader reader = Helper.openReader("E:\\CSC3020SS20\\src\\com\\csc3020\\lecture18\\gz0715\\file1.txt");
             Writer writer = Helper.openWriter("E:\\CSC3020SS20\\src\\com\\csc3020\\lecture18\\gz0715\\file2.txt")) {
            while ((length = reader.read(buff)) >= 0) {
                System.out.println("\nlength: " + length);
                for (int i = 0; i < length; i++) {
                    System.out.print(buff[i]);
    ...
    public static void doBufferedStreaming() {
        try (BufferedReader oBufferedReader = new BufferedReader(new FileReader("E:\\CSC3020SS20\\src\\com\\csc3020\\lecture18\\gz0715\\file1.txt"))) {
            int intVal;
    ...
    public static void doBufferedWriting(String[] data){
        try (BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("E:\\CSC3020SS20\\src\\com\\csc3020\\lecture18\\gz0715\\data.txt"))) {
    ...
    public static void doBufferedReadlingLine() throws IOException {
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader("E:\\CSC3020SS20\\src\\com\\csc3020\\lecture18\\gz0715\\data.txt"))) {
            String strValue;
