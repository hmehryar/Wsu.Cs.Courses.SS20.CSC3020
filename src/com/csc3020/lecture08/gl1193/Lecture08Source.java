package com.csc3020.lecture08.gl1193;
...
public class Lecture08Source {
    ...
    public static void main(String[] args) {
        ...
        oFlight.add1Passengers();
        oFlight.print();
        oFlight.add1Passengers(2);
        oFlight.print();
        oFlight.add1Passengers(oPassenger1);
        oFlight.print();

        short threeBags=3;
        oFlight.add1Passengers(threeBags,2);
        oFlight.print();
        oFlight.add1Passengers(oPassenger2,1);
        oFlight.print();
    }
