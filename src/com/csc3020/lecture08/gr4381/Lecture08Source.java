package csc3020.lecture08.gr4381;
...
//        flight2 = new Flight(20);
    ...
    static void swapNumbers(Flight i, Flight j){
        Flight k = new Flight(i.getFlightNumber());
        i.setFlightNumber(j.getFlightNumber());
        j.setFlightNumber(k.getFlightNumber());
        System.out.println("Inside swapNumbers function");
        System.out.println(i.getFlightNumber());
        System.out.println(j.getFlightNumber());
        System.out.println("Exiting swapNumbers function...");
    }
}
