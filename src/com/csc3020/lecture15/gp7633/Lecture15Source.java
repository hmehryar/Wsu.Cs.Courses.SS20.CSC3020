...
import static csc3020.lecture15.gp7633.Flight.getAllPassengers;
import static csc3020.lecture15.gp7633.Flight.resetAllPassengers;
...
//        Static Initialization Block\
        ...
        CrewMember fAttendent = CrewManager.FindAvailable(FlightCrewJob.FlightAttendant);
        System.out.println(fAttendent);
        ...
        System.out.println("Extracting Air Marshell");
        ...
        if (steve.getRewardProgram().getMemberLevel() == platinum.getMemberLevel())
            ...
            System.out.println("Steve is regular");
    }
}
