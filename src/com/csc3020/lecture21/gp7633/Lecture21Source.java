package csc3020.lecture21.gp7633;
...
public class Lecture21Source {
    public static void main(String[] args) {
        ...
        oMyClassTreeWithComparator.forEach(current -> System.out.println(current.getValue()));
        ...
        SortedMap<String, String> hMap = oSortedMap.headMap("3333");
        hMap.forEach((key, value) -> {
            System.out.println(key + " | " + value);
        });
        SortedMap<String, String> tMap = oSortedMap.tailMap("3333");
